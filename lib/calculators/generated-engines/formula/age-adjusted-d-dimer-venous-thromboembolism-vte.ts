 ...
 * sourceId: calc.age-adjusted-d-dimer-venous-thromboembolism-vte
 * slug: age-adjusted-d-dimer-venous-thromboembolism-vte
 * version: 1.0.0
...
export const engine: CalculatorEngine<GeneratedInput, GeneratedOutput> = {
  ...
  calculate(input): CalculatorEngineResult<GeneratedOutput> {
    ...
    try {
      const primaryValue = (((__num(input["UOMSYSTEM"]) === false)) ? (((((__num(input["lab"]) || 0) >= __div((((__num(input["type"]) === 0)) ? ((__num(input["age"]) * 10)) : ((__num(input["age"]) * 5))), 1000))) ? ("VTE possible") : ("VTE unlikely"))) : ((((__num(input["UOMSYSTEM"]) === true)) ? (((((__num(input["lab"]) || 0) >= (((__num(input["type"]) === 0)) ? ((__num(input["age"]) * 10)) : ((__num(input["age"]) * 5))))) ? ("VTE possible") : ("VTE unlikely"))) : (""))));
      ...
      const extras = [
        { id: "10138_Age-Adjusted D-dimer_result", label: "10138_Age-Adjusted D-dimer_result", value: (((__num(input["UOMSYSTEM"]) === false)) ? (__div((((__num(input["type"]) === 0)) ? ((__num(input["age"]) * 10)) : ((__num(input["age"]) * 5))), 1000)) : ((((__num(input["type"]) === 0)) ? ((__num(input["age"]) * 10)) : ((__num(input["age"]) * 5))))) },
        { id: "10138_Age-Adjusted D-dimer_interpretation", label: "10138_Age-Adjusted D-dimer_interpretation", value: (((__num(input["UOMSYSTEM"]) === false)) ? (((((__num(input["lab"]) || 0) >= __div((((__num(input["type"]) === 0)) ? ((__num(input["age"]) * 10)) : ((__num(input["age"]) * 5))), 1000))) ? ("VTE possible") : ("VTE unlikely"))) : ((((__num(input["UOMSYSTEM"]) === true)) ? (((((__num(input["lab"]) || 0) >= (((__num(input["type"]) === 0)) ? ((__num(input["age"]) * 10)) : ((__num(input["age"]) * 5))))) ? ("VTE possible") : ("VTE unlikely"))) : ("")))) },
        { id: "mini", label: "mini", value: (__num(input["age"]) * 10) },
        { id: "10138_Age-Adjusted D-dimer_result (FEU)", label: "10138_Age-Adjusted D-dimer_result (FEU)", value: (__num(input["age"]) * 10) },
        { id: "10138_Age-Adjusted D-dimer_result (DDU)", label: "10138_Age-Adjusted D-dimer_result (DDU)", value: (__num(input["age"]) * 5) },
      ];
      return {
        ok: true,
        output: {
