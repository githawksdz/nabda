 ...
 * sourceId: calc.friedewald-equation-low-density-lipoprotein-cholesterol-ldl-c
 * slug: friedewald-equation-low-density-lipoprotein-cholesterol-ldl-c
 * version: 1.0.0
...
const REQUIRED = ["total_cholesterol","hdl_cholesterol","triglycerides"] as const;

export const engine: CalculatorEngine<GeneratedInput, GeneratedOutput> = {
  slug: "friedewald-equation-low-density-lipoprotein-cholesterol-ldl-c",
  version: "1.0.0-374bc7",
  ...
  calculate(input): CalculatorEngineResult<GeneratedOutput> {
    ...
    try {
      const primaryValue = __round((((__num(input["UOMSYSTEM"]) === false)) ? (((((((__num(input["UOMSYSTEM"]) === false)) ? (__div(__num(input["total_cholesterol"]), 0.0259)) : (__num(input["total_cholesterol"]))) - (((__num(input["UOMSYSTEM"]) === false)) ? (__div(__num(input["hdl_cholesterol"]), 0.0259)) : (__num(input["hdl_cholesterol"])))) - __div((((__num(input["UOMSYSTEM"]) === false)) ? (__div(__num(input["triglycerides"]), 0.0113)) : (__num(input["triglycerides"]))), 5)) * 0.0259)) : ((((((__num(input["UOMSYSTEM"]) === false)) ? (__div(__num(input["total_cholesterol"]), 0.0259)) : (__num(input["total_cholesterol"]))) - (((__num(input["UOMSYSTEM"]) === false)) ? (__div(__num(input["hdl_cholesterol"]), 0.0259)) : (__num(input["hdl_cholesterol"])))) - __div((((__num(input["UOMSYSTEM"]) === false)) ? (__div(__num(input["triglycerides"]), 0.0113)) : (__num(input["triglycerides"]))), 5)))), 1);
      ...
      const extras = [
        { id: "70_LDL Calculated_result", label: "70_LDL Calculated_result", value: __round((((__num(input["UOMSYSTEM"]) === false)) ? (((((((__num(input["UOMSYSTEM"]) === false)) ? (__div(__num(input["total_cholesterol"]), 0.0259)) : (__num(input["total_cholesterol"]))) - (((__num(input["UOMSYSTEM"]) === false)) ? (__div(__num(input["hdl_cholesterol"]), 0.0259)) : (__num(input["hdl_cholesterol"])))) - __div((((__num(input["UOMSYSTEM"]) === false)) ? (__div(__num(input["triglycerides"]), 0.0113)) : (__num(input["triglycerides"]))), 5)) * 0.0259)) : ((((((__num(input["UOMSYSTEM"]) === false)) ? (__div(__num(input["total_cholesterol"]), 0.0259)) : (__num(input["total_cholesterol"]))) - (((__num(input["UOMSYSTEM"]) === false)) ? (__div(__num(input["hdl_cholesterol"]), 0.0259)) : (__num(input["hdl_cholesterol"])))) - __div((((__num(input["UOMSYSTEM"]) === false)) ? (__div(__num(input["triglycerides"]), 0.0113)) : (__num(input["triglycerides"]))), 5)))), 1) },
      ];
      return {
        ok: true,
        output: {
          value: primaryValue,
          label: "Calculated LDL level",
          unit: String((((__num(input["UOMSYSTEM"]) === false)) ? ("mmol/L") : ("mg/dL"))),
          extras,
        },
      };
    } catch {
