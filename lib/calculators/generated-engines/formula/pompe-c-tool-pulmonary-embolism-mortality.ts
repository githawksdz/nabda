 ...
 * sourceId: calc.pompe-c-tool-pulmonary-embolism-mortality
...
const REQUIRED = ["dnr","resp_dist","uls","ams","hr","rr","wt","sat"] as const;

export const engine: CalculatorEngine<GeneratedInput, GeneratedOutput> = {
  slug: "pompe-c-tool-pulmonary-embolism-mortality",
  version: "1.0.0-226116",
  ...
  calculate(input): CalculatorEngineResult<GeneratedOutput> {
    ...
    try {
      const primaryValue = __round((100 * (1 - __div(1, (1 + Math.exp(((((((((3.718 + (1.551711 * __num(input["dnr"]))) + (0.799617 * __num(input["resp_dist"]))) + (0.734339 * __num(input["uls"]))) + (1.473451 * __num(input["ams"]))) + (__num(input["hr"]) * 1.027895)) + (0.04422 * __num(input["rr"]))) + ((0 - 0.063644) * __num(input["sat"]))) + ((0 - 0.011613) * (__num(input["wt"]) * 2.2)))))))), 0);
      ...
      const extras = [
        { id: "2022_POMPE-C Tool_result", label: "Chance of mortality within 30 days.", value: __round((100 * (1 - __div(1, (1 + Math.exp(((((((((3.718 + (1.551711 * __num(input["dnr"]))) + (0.799617 * __num(input["resp_dist"]))) + (0.734339 * __num(input["uls"]))) + (1.473451 * __num(input["ams"]))) + (__num(input["hr"]) * 1.027895)) + (0.04422 * __num(input["rr"]))) + ((0 - 0.063644) * __num(input["sat"]))) + ((0 - 0.011613) * (__num(input["wt"]) * 2.2)))))))), 0) },
      ];
      return {
        ok: true,
        output: {
          value: primaryValue,
          label: "Chance of 30-day mortality",
          unit: "%",
          extras,
        },
      };
