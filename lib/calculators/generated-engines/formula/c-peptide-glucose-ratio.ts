 ...
 * sourceId: calc.c-peptide-glucose-ratio
 * slug: c-peptide-glucose-ratio
 * version: 1.0.0
...
export const engine: CalculatorEngine<GeneratedInput, GeneratedOutput> = {
  ...
  calculate(input): CalculatorEngineResult<GeneratedOutput> {
    ...
    try {
      const primaryValue = __round((((__num(input["picker"]) === 1)) ? (__div((((__num(input["UOMSYSTEM"]) === false)) ? (((((__num(input["UOMSYSTEM"]) === true)) ? (__num(input["cpr"])) : (0)) * 331.093)) : ((((__num(input["UOMSYSTEM"]) === true)) ? (__num(input["cpr"])) : (0)))), (((__num(input["UOMSYSTEM"]) === false)) ? (__div((((__num(input["UOMSYSTEM"]) === true)) ? (__num(input["glu"])) : (0)), 0.0555)) : ((((__num(input["UOMSYSTEM"]) === true)) ? (__num(input["glu"])) : (0)))))) : ((__div(((((__num(input["UOMSYSTEM"]) === false)) ? (((((__num(input["UOMSYSTEM"]) === true)) ? (__num(input["cpr"])) : (0)) * 331.093)) : ((((__num(input["UOMSYSTEM"]) === true)) ? (__num(input["cpr"])) : (0)))) * 0.0030203), (((__num(input["UOMSYSTEM"]) === false)) ? (__div((((__num(input["UOMSYSTEM"]) === true)) ? (__num(input["glu"])) : (0)), 0.0555)) : ((((__num(input["UOMSYSTEM"]) === true)) ? (__num(input["glu"])) : (0))))) * 100))), 2);
      ...
      const extras = [
        { id: "10529_C-Peptide to Glucose Ratio_result", label: "10529_C-Peptide to Glucose Ratio_result", value: __round((((__num(input["picker"]) === 1)) ? (__div((((__num(input["UOMSYSTEM"]) === false)) ? (((((__num(input["UOMSYSTEM"]) === true)) ? (__num(input["cpr"])) : (0)) * 331.093)) : ((((__num(input["UOMSYSTEM"]) === true)) ? (__num(input["cpr"])) : (0)))), (((__num(input["UOMSYSTEM"]) === false)) ? (__div((((__num(input["UOMSYSTEM"]) === true)) ? (__num(input["glu"])) : (0)), 0.0555)) : ((((__num(input["UOMSYSTEM"]) === true)) ? (__num(input["glu"])) : (0)))))) : ((__div(((((__num(input["UOMSYSTEM"]) === false)) ? (((((__num(input["UOMSYSTEM"]) === true)) ? (__num(input["cpr"])) : (0)) * 331.093)) : ((((__num(input["UOMSYSTEM"]) === true)) ? (__num(input["cpr"])) : (0)))) * 0.0030203), (((__num(input["UOMSYSTEM"]) === false)) ? (__div((((__num(input["UOMSYSTEM"]) === true)) ? (__num(input["glu"])) : (0)), 0.0555)) : ((((__num(input["UOMSYSTEM"]) === true)) ? (__num(input["glu"])) : (0))))) * 100))), 2) },
      ];
      return {
        ok: true,
        output: {
