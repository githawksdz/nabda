 ...
 * sourceId: calc.h2fpef-score-for-heart-failure-with-preserved-ejection-fraction
...
export const engine: CalculatorEngine<GeneratedInput, GeneratedOutput> = {
  ...
  calculate(input): CalculatorEngineResult<GeneratedOutput> {
    ...
    try {
      const primaryValue = __round((__div(Math.pow(2.718281828459045, ((((((0 - 9.19174463966566) + (0.0451129471272832 * __num(input["age"]))) + (0.130730156015681 * __num(input["bmi"]))) + (0.0858634402456586 * __num(input["eratio"]))) + (0.051963758732548 * __num(input["sp"]))) + (1.69968057294513 * __num(input["af"])))), (1 + Math.pow(2.718281828459045, ((((((0 - 9.19174463966566) + (0.0451129471272832 * __num(input["age"]))) + (0.130730156015681 * __num(input["bmi"]))) + (0.0858634402456586 * __num(input["eratio"]))) + (0.051963758732548 * __num(input["sp"]))) + (1.69968057294513 * __num(input["af"])))))) * 100), 1);
      ...
      const extras = [
        { id: "10105_H2FPEF Score_result", label: "Probability of heart failure with preserved EF", value: __round((__div(Math.pow(2.718281828459045, ((((((0 - 9.19174463966566) + (0.0451129471272832 * __num(input["age"]))) + (0.130730156015681 * __num(input["bmi"]))) + (0.0858634402456586 * __num(input["eratio"]))) + (0.051963758732548 * __num(input["sp"]))) + (1.69968057294513 * __num(input["af"])))), (1 + Math.pow(2.718281828459045, ((((((0 - 9.19174463966566) + (0.0451129471272832 * __num(input["age"]))) + (0.130730156015681 * __num(input["bmi"]))) + (0.0858634402456586 * __num(input["eratio"]))) + (0.051963758732548 * __num(input["sp"]))) + (1.69968057294513 * __num(input["af"])))))) * 100), 1) },
      ];
      return {
        ok: true,
        output: {
          value: primaryValue,
          label: "Probability of heart failure with preserved EF",
          unit: "%",
          extras,
        },
      };
