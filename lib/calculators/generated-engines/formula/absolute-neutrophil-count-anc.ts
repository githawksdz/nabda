 ...
 * sourceId: calc.absolute-neutrophil-count-anc
...
const REQUIRED = ["neutrophils","bands","white_blood_cell_count"] as const;

export const engine: CalculatorEngine<GeneratedInput, GeneratedOutput> = {
  slug: "absolute-neutrophil-count-anc",
  version: "1.0.0-68a89f",
  ...
  calculate(input): CalculatorEngineResult<GeneratedOutput> {
    ...
    try {
      const primaryValue = ((10 * __num(input["white_blood_cell_count"])) * (__num(input["bands"]) + __num(input["neutrophils"])));
      ...
      const extras = [
        { id: "mini", label: "High ANC", value: ((10 * __num(input["white_blood_cell_count"])) * (__num(input["bands"]) + __num(input["neutrophils"]))) },
        { id: "19_Absolute Neutrophil Count_result", label: "Absolute Neutrophil Count", value: ((10 * __num(input["white_blood_cell_count"])) * (__num(input["bands"]) + __num(input["neutrophils"]))) },
        { id: "19_Absolute Neutrophil Count_interpretation", label: "", value: (((((10 * __num(input["white_blood_cell_count"])) * (__num(input["bands"]) + __num(input["neutrophils"]))) > 7700)) ? ("Neutrophilia") : (((((((10 * __num(input["white_blood_cell_count"])) * (__num(input["bands"]) + __num(input["neutrophils"]))) >= 1500) && (((10 * __num(input["white_blood_cell_count"])) * (__num(input["bands"]) + __num(input["neutrophils"]))) <= 7700))) ? ("Normal; no") : (((((((10 * __num(input["white_blood_cell_count"])) * (__num(input["bands"]) + __num(input["neutrophils"]))) >= 1000) && (((10 * __num(input["white_blood_cell_count"])) * (__num(input["bands"]) + __num(input["neutrophils"]))) < 1500))) ? ("Mild") : (((((((10 * __num(input["white_blood_cell_count"])) * (__num(input["bands"]) + __num(input["neutrophils"]))) >= 500) && (((10 * __num(input["white_blood_cell_count"])) * (__num(input["bands"]) + __num(input["neutrophils"]))) < 1000))) ? ("Moderate") : ((((((10 * __num(input["white_blood_cell_count"])) * (__num(input["bands"]) + __num(input["neutrophils"]))) < 500)) ? ("Severe") : ("")))))))))) },
        { id: "19_Absolute Neutrophil Count_interpretation", label: "No neutropenia", value: "Normal" },
        { id: "19_Absolute Neutrophil Count_interpretation", label: "19_Absolute Neutrophil Count_interpretation", value: "High ANC" },
      ];
      return {
        ok: true,
        output: {
