 ...
 * sourceId: calc.relative-fat-mass-rfm
...
export const engine: CalculatorEngine<GeneratedInput, GeneratedOutput> = {
  ...
  calculate(input): CalculatorEngineResult<GeneratedOutput> {
    ...
    try {
      const primaryValue = __round(((64 - (20 * __div(__num(input["height"]), __num(input["waist"])))) + (12 * __num(input["sex"]))), 1);
      ...
      const extras = [
        { id: "RFM", label: "Relative Fat Mass", value: __round(((64 - (20 * __div(__num(input["height"]), __num(input["waist"])))) + (12 * __num(input["sex"]))), 1) },
        { id: "Class", label: "Classification", value: ((((__num(input["sex"]) === 1) && (((64 - (20 * __div(__num(input["height"]), __num(input["waist"])))) + (12 * __num(input["sex"]))) >= 33.9))) ? ("Obese") : (((((__num(input["sex"]) === 0) && (((64 - (20 * __div(__num(input["height"]), __num(input["waist"])))) + (12 * __num(input["sex"]))) >= 22.8))) ? ("Obese") : ("Not obese")))) },
      ];
      return {
        ok: true,
        output: {
