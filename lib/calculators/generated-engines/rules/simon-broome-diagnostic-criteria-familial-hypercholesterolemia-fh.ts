 ...
 * sourceId: calc.simon-broome-diagnostic-criteria-familial-hypercholesterolemia-fh
...
const REQUIRED = ["age","tchol","ldl","xan","dna","cvd","fam"] as const;

export const engine: CalculatorEngine<GeneratedInput, GeneratedOutput> = {
  slug: "simon-broome-diagnostic-criteria-familial-hypercholesterolemia-fh",
  version: "1.0.0-3eaa7f",
  ...
  calculate(input): CalculatorEngineResult<GeneratedOutput> {
    ...
    try {
      ...
      const extras = [
        { id: "3817_Simon Broome Diagnostic Criteria_result", label: "3817_Simon Broome Diagnostic Criteria_result", value: (((((((__num(input["age"]) === 1)) ? (((((((__num(input["age"]) === 2)) ? (((("" > 290)) ? (1) : (0))) : ("")) > 260)) ? (1) : (0))) : ((((__num(input["age"]) === 2)) ? (((("" > 290)) ? (1) : (0))) : ("")))) + (((__num(input["age"]) === 1)) ? (((((((__num(input["age"]) === 2)) ? (((("" > 190)) ? (1) : (0))) : ("")) > 155)) ? (1) : (0))) : ((((__num(input["age"]) === 2)) ? (((("" > 190)) ? (1) : (0))) : (""))))) >= 1)) ? (((((__num(input["xan"]) + __num(input["dna"])) === 0)) ? (((((__num(input["cvd"]) + __num(input["fam"])) >= 1)) ? ("Possible") : (((((__num(input["xan"]) + __num(input["dna"])) >= 1)) ? ("Definite") : (((((((__num(input["xan"]) + __num(input["dna"])) + __num(input["cvd"])) + __num(input["fam"])) === 0)) ? ("Unlikely") : (""))))))) : (((((__num(input["xan"]) + __num(input["dna"])) >= 1)) ? ("Definite") : (((((((__num(input["xan"]) + __num(input["dna"])) + __num(input["cvd"])) + __num(input["fam"])) === 0)) ? ("Unlikely") : (""))))))) : ((((((((__num(input["age"]) === 1)) ? (((((((__num(input["age"]) === 2)) ? (((("" > 290)) ? (1) : (0))) : ("")) > 260)) ? (1) : (0))) : ((((__num(input["age"]) === 2)) ? (((("" > 290)) ? (1) : (0))) : ("")))) + (((__num(input["age"]) === 1)) ? (((((((__num(input["age"]) === 2)) ? (((("" > 190)) ? (1) : (0))) : ("")) > 155)) ? (1) : (0))) : ((((__num(input["age"]) === 2)) ? (((("" > 190)) ? (1) : (0))) : (""))))) === 0)) ? ("Unlikely") : ("")))) },
      ];
      return {
        ok: true,
        output: {
