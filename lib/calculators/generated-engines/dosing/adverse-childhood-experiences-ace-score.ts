 ...
 * sourceId: calc.adverse-childhood-experiences-ace-score
 * slug: adverse-childhood-experiences-ace-score
 * version: 1.0.0
...
export const engine: CalculatorEngine<GeneratedInput, GeneratedOutput> = {
  ...
  calculate(input): CalculatorEngineResult<GeneratedOutput> {
    ...
    try {
      const primaryValue = (((((((((__num(input["q1"]) + __num(input["q2"])) + __num(input["q3"])) + __num(input["q4"])) + __num(input["q5"])) + __num(input["q6"])) + __num(input["q7"])) + __num(input["q8"])) + __num(input["q9"])) + __num(input["q10"]));
      ...
      const extras = [
        { id: "score", label: "ACE Score  A higher ACE Score corresponds with a higher risk of health, social, and emotional problems.", value: (((((((((__num(input["q1"]) + __num(input["q2"])) + __num(input["q3"])) + __num(input["q4"])) + __num(input["q5"])) + __num(input["q6"])) + __num(input["q7"])) + __num(input["q8"])) + __num(input["q9"])) + __num(input["q10"])) },
      ];
      return {
        ok: true,
        output: {
          value: primaryValue,
          label: "A higher ACE Score corresponds with a higher risk of health, social, and emotional problems.",
          unit: "points",
          extras,
        },
      };
