 ...
 * sourceId: calc.hat-hemorrhage-thrombolysis-score-predicting-post-tpa-hemorrhage
...
const REQUIRED = ["hist","nihss_score","hypodensity"] as const;

export const engine: CalculatorEngine<GeneratedInput, GeneratedOutput> = {
  slug: "hat-hemorrhage-thrombolysis-score-predicting-post-tpa-hemorrhage",
  version: "1.0.0-f68c78",
  ...
  calculate(input): CalculatorEngineResult<GeneratedOutput> {
    ...
    try {
      const primaryValue = __round(((__num(input["hist"]) + __num(input["nihss_score"])) + __num(input["hypodensity"])), 0);
      ...
      const extras = [
        { id: "2030_HAT Score_result (score)", label: "HAT Score", value: __round(((__num(input["hist"]) + __num(input["nihss_score"])) + __num(input["hypodensity"])), 0) },
        { id: "2030_HAT Score_result (symptomatic)", label: "Risk of Symptomatic ICH.", value: (((((__num(input["hist"]) + __num(input["nihss_score"])) + __num(input["hypodensity"])) === 0)) ? ("2") : ((((((__num(input["hist"]) + __num(input["nihss_score"])) + __num(input["hypodensity"])) === 1)) ? ("5") : ((((((__num(input["hist"]) + __num(input["nihss_score"])) + __num(input["hypodensity"])) === 2)) ? ("10") : ((((((__num(input["hist"]) + __num(input["nihss_score"])) + __num(input["hypodensity"])) === 3)) ? ("15") : ((((((__num(input["hist"]) + __num(input["nihss_score"])) + __num(input["hypodensity"])) > 3)) ? ("44") : ("")))))))))) },
        { id: "2030_HAT Score_result (fatal)", label: "Risk of Fatal ICH.", value: (((((__num(input["hist"]) + __num(input["nihss_score"])) + __num(input["hypodensity"])) === 0)) ? ("0") : ((((((__num(input["hist"]) + __num(input["nihss_score"])) + __num(input["hypodensity"])) === 1)) ? ("3") : ((((((__num(input["hist"]) + __num(input["nihss_score"])) + __num(input["hypodensity"])) === 2)) ? ("7") : ((((((__num(input["hist"]) + __num(input["nihss_score"])) + __num(input["hypodensity"])) === 3)) ? ("6") : ((((((__num(input["hist"]) + __num(input["nihss_score"])) + __num(input["hypodensity"])) > 3)) ? ("33") : ("")))))))))) },
      ];
      return {
        ok: true,
        output: {
