...
const REQUIRED = ["immuno","bmi","fracture","esa","dox","dex","race","hx","tunnel","warfarin","aspirin"] as const;

export const engine: CalculatorEngine<GeneratedInput, GeneratedOutput> = {
  slug: "impede-vte",
  version: "1.0.0-ef3aa4",
  ...
  calculate(input): CalculatorEngineResult<GeneratedOutput> {
    ...
    try {
      const primaryValue = ((((((((((__num(input["immuno"]) + __num(input["bmi"])) + __num(input["fracture"])) + __num(input["esa"])) + __num(input["dox"])) + __num(input["dex"])) + __num(input["race"])) + __num(input["hx"])) + __num(input["tunnel"])) + __num(input["warfarin"])) + __num(input["aspirin"]));
      ...
      const extras = [
        { id: "10498_IMPEDE-VTE_result", label: "IMPEDE-VTE Score", value: ((((((((((__num(input["immuno"]) + __num(input["bmi"])) + __num(input["fracture"])) + __num(input["esa"])) + __num(input["dox"])) + __num(input["dex"])) + __num(input["race"])) + __num(input["hx"])) + __num(input["tunnel"])) + __num(input["warfarin"])) + __num(input["aspirin"])) },
        { id: "10498_IMPEDE-VTE_interpretation", label: "Risk of VTE within 6 months of treatment initiation", value: (((((((((((((__num(input["immuno"]) + __num(input["bmi"])) + __num(input["fracture"])) + __num(input["esa"])) + __num(input["dox"])) + __num(input["dex"])) + __num(input["race"])) + __num(input["hx"])) + __num(input["tunnel"])) + __num(input["warfarin"])) + __num(input["aspirin"])) <= 3)) ? ("Low") : ((((((((((((((__num(input["immuno"]) + __num(input["bmi"])) + __num(input["fracture"])) + __num(input["esa"])) + __num(input["dox"])) + __num(input["dex"])) + __num(input["race"])) + __num(input["hx"])) + __num(input["tunnel"])) + __num(input["warfarin"])) + __num(input["aspirin"])) <= 7)) ? ("Intermediate") : ("High")))) },
      ];
      return {
        ok: true,
        output: {
