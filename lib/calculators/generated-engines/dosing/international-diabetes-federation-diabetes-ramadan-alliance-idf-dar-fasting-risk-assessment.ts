 ...
 * sourceId: calc.international-diabetes-federation-diabetes-ramadan-alliance-idf-dar-fasting-risk-assessment
 * slug: international-diabetes-federation-diabetes-ramadan-alliance-idf-dar-fasting-risk-assessment
 * version: 1.0.0
...
const REQUIRED = ["q1","q2","q3","q4","q5","q6","q7","q8","q9","q10","q11","q12","q13","q14"] as const;

export const engine: CalculatorEngine<GeneratedInput, GeneratedOutput> = {
  slug: "international-diabetes-federation-diabetes-ramadan-alliance-idf-dar-fasting-risk-assessment",
  version: "1.0.0-dd34f2",
  ...
  calculate(input): CalculatorEngineResult<GeneratedOutput> {
    ...
    try {
      const primaryValue = (((((((((((((__num(input["q1"]) + __num(input["q2"])) + __num(input["q3"])) + __num(input["q4"])) + __num(input["q5"])) + __num(input["q6"])) + __num(input["q7"])) + __num(input["q8"])) + __num(input["q9"])) + __num(input["q10"])) + __num(input["q11"])) + __num(input["q12"])) + __num(input["q13"])) + __num(input["q14"]));
      ...
      const extras = [
        { id: "10522_IDF-DAR_result", label: "Risk score", value: (((((((((((((__num(input["q1"]) + __num(input["q2"])) + __num(input["q3"])) + __num(input["q4"])) + __num(input["q5"])) + __num(input["q6"])) + __num(input["q7"])) + __num(input["q8"])) + __num(input["q9"])) + __num(input["q10"])) + __num(input["q11"])) + __num(input["q12"])) + __num(input["q13"])) + __num(input["q14"])) },
        { id: "10522_IDF-DAR_interpretation", label: "Fasting risk level", value: (((((((((((((((((__num(input["q1"]) + __num(input["q2"])) + __num(input["q3"])) + __num(input["q4"])) + __num(input["q5"])) + __num(input["q6"])) + __num(input["q7"])) + __num(input["q8"])) + __num(input["q9"])) + __num(input["q10"])) + __num(input["q11"])) + __num(input["q12"])) + __num(input["q13"])) + __num(input["q14"])) >= 0) && ((((((((((((((__num(input["q1"]) + __num(input["q2"])) + __num(input["q3"])) + __num(input["q4"])) + __num(input["q5"])) + __num(input["q6"])) + __num(input["q7"])) + __num(input["q8"])) + __num(input["q9"])) + __num(input["q10"])) + __num(input["q11"])) + __num(input["q12"])) + __num(input["q13"])) + __num(input["q14"])) <= 3))) ? ("Low") : ((((((((((((((((((__num(input["q1"]) + __num(input["q2"])) + __num(input["q3"])) + __num(input["q4"])) + __num(input["q5"])) + __num(input["q6"])) + __num(input["q7"])) + __num(input["q8"])) + __num(input["q9"])) + __num(input["q10"])) + __num(input["q11"])) + __num(input["q12"])) + __num(input["q13"])) + __num(input["q14"])) >= 3.5) && ((((((((((((((__num(input["q1"]) + __num(input["q2"])) + __num(input["q3"])) + __num(input["q4"])) + __num(input["q5"])) + __num(input["q6"])) + __num(input["q7"])) + __num(input["q8"])) + __num(input["q9"])) + __num(input["q10"])) + __num(input["q11"])) + __num(input["q12"])) + __num(input["q13"])) + __num(input["q14"])) <= 6))) ? ("Moderate") : ("High")))) },
      ];
      return {
        ok: true,
        output: {
