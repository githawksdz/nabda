 ...
 * sourceId: calc.hydroxychloroquine-plaquenil-dosing-calculator
 * slug: hydroxychloroquine-plaquenil-dosing-calculator
 * version: 1.0.0
...
export const engine: CalculatorEngine<GeneratedInput, GeneratedOutput> = {
  ...
  calculate(input): CalculatorEngineResult<GeneratedOutput> {
    ...
    try {
      const primaryValue = __round(((((__num(input["UOMSYSTEM"]) === true)) ? (("" * 0.453592)) : ("")) * 5), 0);
      ...
      const extras = [
        { id: "10080_Hydroxychloroquine (Plaquenil) Dosing_result (max)", label: "Maximum daily dose of hydroxychloroquine", value: __round(((((__num(input["UOMSYSTEM"]) === true)) ? (("" * 0.453592)) : ("")) * 5), 0) },
        { id: "10080_Hydroxychloroquine (Plaquenil) Dosing_result (dose/weight)", label: "10080_Hydroxychloroquine (Plaquenil) Dosing_result (dose/weight)", value: __round(__div((__num(input["dose"]) || 0), (((__num(input["UOMSYSTEM"]) === true)) ? (("" * 0.453592)) : (""))), 1) },
        { id: "10080_Hydroxychloroquine (Plaquenil) Dosing_result (risk)", label: "10080_Hydroxychloroquine (Plaquenil) Dosing_result (risk)", value: ((((__round(__div((__num(input["dose"]) || 0), (((__num(input["UOMSYSTEM"]) === true)) ? (("" * 0.453592)) : (""))), 1) >= 4) && (__round(__div((__num(input["dose"]) || 0), (((__num(input["UOMSYSTEM"]) === true)) ? (("" * 0.453592)) : (""))), 1) <= 5))) ? (2) : ((((__round(__div((__num(input["dose"]) || 0), (((__num(input["UOMSYSTEM"]) === true)) ? (("" * 0.453592)) : (""))), 1) > 5)) ? (10) : ("")))) },
      ];
      return {
        ok: true,
        output: {
          value: primaryValue,
          label: "Max daily hydroxychloroquine dose",
          unit: "mg",
          extras,
        },
      };
