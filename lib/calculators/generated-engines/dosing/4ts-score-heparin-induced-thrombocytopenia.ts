 ...
 * sourceId: calc.4ts-score-heparin-induced-thrombocytopenia
 * slug: 4ts-score-heparin-induced-thrombocytopenia
 * version: 1.0.0
...
const REQUIRED = ["thrombocytopenia","platelet_fall_timing","thrombosis","other_causes_thrombocytopenia"] as const;

export const engine: CalculatorEngine<GeneratedInput, GeneratedOutput> = {
  slug: "4ts-score-heparin-induced-thrombocytopenia",
  version: "1.0.0-5f6ce9",
  ...
  calculate(input): CalculatorEngineResult<GeneratedOutput> {
    ...
    try {
      const primaryValue = ((((((__num(input["thrombocytopenia"]) + __num(input["platelet_fall_timing"])) + __num(input["thrombosis"])) + __num(input["other_causes_thrombocytopenia"])) > 5)) ? ("~64%") : ((((((((__num(input["thrombocytopenia"]) + __num(input["platelet_fall_timing"])) + __num(input["thrombosis"])) + __num(input["other_causes_thrombocytopenia"])) === 4) || ((((__num(input["thrombocytopenia"]) + __num(input["platelet_fall_timing"])) + __num(input["thrombosis"])) + __num(input["other_causes_thrombocytopenia"])) === 5))) ? ("~14%") : (((((((__num(input["thrombocytopenia"]) + __num(input["platelet_fall_timing"])) + __num(input["thrombosis"])) + __num(input["other_causes_thrombocytopenia"])) < 4)) ? ("<5%") : (""))))));
      ...
      const extras = [
        { id: "1787_4Ts for HIT_result", label: "1787_4Ts for HIT_result", value: (((__num(input["thrombocytopenia"]) + __num(input["platelet_fall_timing"])) + __num(input["thrombosis"])) + __num(input["other_causes_thrombocytopenia"])) },
      ];
      return {
        ok: true,
        output: {
