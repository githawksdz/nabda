 ...
 * sourceId: calc.4-level-pulmonary-embolism-clinical-probability-score-4peps
 * slug: 4-level-pulmonary-embolism-clinical-probability-score-4peps
 * version: 1.0.0
...
const REQUIRED = ["age","sex","resp","bpm","chest","estrogen","vte","sync","imm","pulse","calf","pediag"] as const;

export const engine: CalculatorEngine<GeneratedInput, GeneratedOutput> = {
  slug: "4-level-pulmonary-embolism-clinical-probability-score-4peps",
  version: "1.0.0-cbc517",
  ...
  calculate(input): CalculatorEngineResult<GeneratedOutput> {
    ...
    try {
      const primaryValue = ((((((((((((((__num(input["age"]) < 50)) ? ((0 - 2)) : (((((__num(input["age"]) >= 50) && (__num(input["age"]) <= 64))) ? ((0 - 1)) : ((((__num(input["age"]) > 64)) ? (0) : (0)))))) + __num(input["sex"])) + __num(input["resp"])) + __num(input["bpm"])) + __num(input["chest"])) + __num(input["estrogen"])) + __num(input["vte"])) + __num(input["sync"])) + __num(input["imm"])) + __num(input["pulse"])) + __num(input["calf"])) + __num(input["pediag"]));
      ...
      const extras = [
        { id: "4PEPS Score", label: "4PEPS Score", value: ((((((((((((((__num(input["age"]) < 50)) ? ((0 - 2)) : (((((__num(input["age"]) >= 50) && (__num(input["age"]) <= 64))) ? ((0 - 1)) : ((((__num(input["age"]) > 64)) ? (0) : (0)))))) + __num(input["sex"])) + __num(input["resp"])) + __num(input["bpm"])) + __num(input["chest"])) + __num(input["estrogen"])) + __num(input["vte"])) + __num(input["sync"])) + __num(input["imm"])) + __num(input["pulse"])) + __num(input["calf"])) + __num(input["pediag"])) },
        { id: "Probability", label: "Probability", value: (((((((((((((((((__num(input["age"]) < 50)) ? ((0 - 2)) : (((((__num(input["age"]) >= 50) && (__num(input["age"]) <= 64))) ? ((0 - 1)) : ((((__num(input["age"]) > 64)) ? (0) : (0)))))) + __num(input["sex"])) + __num(input["resp"])) + __num(input["bpm"])) + __num(input["chest"])) + __num(input["estrogen"])) + __num(input["vte"])) + __num(input["sync"])) + __num(input["imm"])) + __num(input["pulse"])) + __num(input["calf"])) + __num(input["pediag"])) >= 13)) ? (">65") : (((((((((((((((((((__num(input["age"]) < 50)) ? ((0 - 2)) : (((((__num(input["age"]) >= 50) && (__num(input["age"]) <= 64))) ? ((0 - 1)) : ((((__num(input["age"]) > 64)) ? (0) : (0)))))) + __num(input["sex"])) + __num(input["resp"])) + __num(input["bpm"])) + __num(input["chest"])) + __num(input["estrogen"])) + __num(input["vte"])) + __num(input["sync"])) + __num(input["imm"])) + __num(input["pulse"])) + __num(input["calf"])) + __num(input["pediag"])) >= 6) && (((((((((((((((__num(input["age"]) < 50)) ? ((0 - 2)) : (((((__num(input["age"]) >= 50) && (__num(input["age"]) <= 64))) ? ((0 - 1)) : ((((__num(input["age"]) > 64)) ? (0) : (0)))))) + __num(input["sex"])) + __num(input["resp"])) + __num(input["bpm"])) + __num(input["chest"])) + __num(input["estrogen"])) + __num(input["vte"])) + __num(input["sync"])) + __num(input["imm"])) + __num(input["pulse"])) + __num(input["calf"])) + __num(input["pediag"])) <= 12))) ? ("20-65") : (((((((((((((((((((__num(input["age"]) < 50)) ? ((0 - 2)) : (((((__num(input["age"]) >= 50) && (__num(input["age"]) <= 64))) ? ((0 - 1)) : ((((__num(input["age"]) > 64)) ? (0) : (0)))))) + __num(input["sex"])) + __num(input["resp"])) + __num(input["bpm"])) + __num(input["chest"])) + __num(input["estrogen"])) + __num(input["vte"])) + __num(input["sync"])) + __num(input["imm"])) + __num(input["pulse"])) + __num(input["calf"])) + __num(input["pediag"])) >= 0) && (((((((((((((((__num(input["age"]) < 50)) ? ((0 - 2)) : (((((__num(input["age"]) >= 50) && (__num(input["age"]) <= 64))) ? ((0 - 1)) : ((((__num(input["age"]) > 64)) ? (0) : (0)))))) + __num(input["sex"])) + __num(input["resp"])) + __num(input["bpm"])) + __num(input["chest"])) + __num(input["estrogen"])) + __num(input["vte"])) + __num(input["sync"])) + __num(input["imm"])) + __num(input["pulse"])) + __num(input["calf"])) + __num(input["pediag"])) <= 5))) ? ("2-20") : ((((((((((((((((((__num(input["age"]) < 50)) ? ((0 - 2)) : (((((__num(input["age"]) >= 50) && (__num(input["age"]) <= 64))) ? ((0 - 1)) : ((((__num(input["age"]) > 64)) ? (0) : (0)))))) + __num(input["sex"])) + __num(input["resp"])) + __num(input["bpm"])) + __num(input["chest"])) + __num(input["estrogen"])) + __num(input["vte"])) + __num(input["sync"])) + __num(input["imm"])) + __num(input["pulse"])) + __num(input["calf"])) + __num(input["pediag"])) < 0)) ? ("<2") : (0)))))))) },
        { id: "PE diagnosis", label: "PE diagnosis", value: "" },
      ];
      return {
        ok: true,
        output: {
