 ...
 * sourceId: calc.charlson-comorbidity-index-cci
 * slug: charlson-comorbidity-index-cci
 * version: 1.0.0
...
const REQUIRED = ["age","mi","chf","pvd","cva_or_tia","dementia","cpd","connective_tissue_disease","pud","liver","dm","hemiplegia","ckd","solid","leuk","lymph","aids","copd"] as const;

export const engine: CalculatorEngine<GeneratedInput, GeneratedOutput> = {
  slug: "charlson-comorbidity-index-cci",
  version: "1.0.0-c5c492",
  ...
  calculate(input): CalculatorEngineResult<GeneratedOutput> {
    ...
    try {
      const primaryValue = ((((((((((((((((__num(input["age"]) + __num(input["aids"])) + __num(input["chf"])) + __num(input["connective_tissue_disease"])) + ((((__num(input["cpd"]) !== "") !== "undefined")) ? (__num(input["cpd"])) : (__num(input["copd"])))) + __num(input["cva_or_tia"])) + __num(input["dementia"])) + __num(input["dm"])) + __num(input["hemiplegia"])) + __num(input["liver"])) + __num(input["ckd"])) + __num(input["mi"])) + __num(input["pud"])) + __num(input["pvd"])) + __num(input["lymph"])) + __num(input["leuk"])) + __num(input["solid"]));
      ...
      const extras = [
        { id: "3917_Charlson Comorbidity Index_result (score)", label: "Charlson Comorbidity Index", value: ((((((((((((((((__num(input["age"]) + __num(input["aids"])) + __num(input["chf"])) + __num(input["connective_tissue_disease"])) + ((((__num(input["cpd"]) !== "") !== "undefined")) ? (__num(input["cpd"])) : (__num(input["copd"])))) + __num(input["cva_or_tia"])) + __num(input["dementia"])) + __num(input["dm"])) + __num(input["hemiplegia"])) + __num(input["liver"])) + __num(input["ckd"])) + __num(input["mi"])) + __num(input["pud"])) + __num(input["pvd"])) + __num(input["lymph"])) + __num(input["leuk"])) + __num(input["solid"])) },
        { id: "3917_Charlson Comorbidity Index_result (survival)", label: "Estimated 10-year survival", value: (__round(Math.pow(0.983, Math.exp((((((((((((((((((__num(input["age"]) + __num(input["aids"])) + __num(input["chf"])) + __num(input["connective_tissue_disease"])) + ((((__num(input["cpd"]) !== "") !== "undefined")) ? (__num(input["cpd"])) : (__num(input["copd"])))) + __num(input["cva_or_tia"])) + __num(input["dementia"])) + __num(input["dm"])) + __num(input["hemiplegia"])) + __num(input["liver"])) + __num(input["ckd"])) + __num(input["mi"])) + __num(input["pud"])) + __num(input["pvd"])) + __num(input["lymph"])) + __num(input["leuk"])) + __num(input["solid"])) * 0.9))), 2) * 100) },
      ];
      return {
        ok: true,
        output: {
